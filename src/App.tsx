  ...
  return (
    <>
      <SEO
        ...
        description="مبادرة صحوة - حركة شبابية طلابية في تركيا تهدف لتكوين جيل واعٍ يحمل هم الأمة. يُعرفنا البعض بـ Sah7a أو صحوه. انضم لبرامجنا: حفظ القرآن، الدروس الشهرية، الديوانية والأنشطة المتنوعة."
        keywords="صحوة, Sahwa, Sah7a, صحوه, مبادرة صحوة, طلاب مسلمين تركيا, جامعة استنيا, جامعة بلجي, أنشطة إسلامية, شباب مسلم"
        canonicalUrl="/"
        siteNameOverride="صحوة Sahwa"
        alternateName={["صحوة","Sahwa","Sah7a","صحوه"]}
